...
<img class="shot" src="img/cap-modes.png" alt="管理画面の実行モード — Fetch / AI / Script / Macro の選択 UI" loading="lazy">
...
- 新ページ: **HTTP API**（任意の言語から）、**FAQ**、**動画の取得と配信のしくみ**、**アーキテクチャ概要 / Hub の仕組み / Worker の仕組み**、**Server インストール**、**CHANGELOG**（本ページ）。
